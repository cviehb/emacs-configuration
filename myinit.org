...
#+BEGIN_SRC emacs-lisp
  ...
  (defun get-move-clearcase ()
    (when (not (file-directory-p clearcase-install-path))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun vhdl-mode-update-hook ()
    "hook for updating the vhdl mode to the newest one"
    (vhdl-mode-update vhdl-mode-git-url vhdl-mode-newest-version))
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'vhdl-mode-hook 'vhdl-mode-update-hook)
